...
document.getElementById("seoulMenu").addEventListener("click", function (event) {
...
document.getElementById("incheonMenu").addEventListener("click", function (event) {    
...
document.getElementById("busanMenu").addEventListener("click", function (event) {    
...
document.getElementById("nationwideButton").addEventListener("click", function () {
    this.classList.toggle("active");
