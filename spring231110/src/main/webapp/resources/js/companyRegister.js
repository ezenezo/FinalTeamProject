  ...
  if (parsedOptions_3.length >= 4) {
    ...
    if (storedOptions_4 !== null) {
      ...
      latestOptions_4 = ["필수항목을 입력해주세요.","필수항목을 입력해주세요.","필수항목을 입력해주세요.","공백(선택항목)"];
            ...
            tr += `<li id="li_final"><input value="${latestOptions}" id="optionValue" readonly="readonly" name ="form" class="optionfinal"><button type="button" onclick="getCommentList()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_1}" id="optionValue" readonly="readonly" name ="categoryType"class="optionfinal"><button type="button" onclick="handleClick()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_2_1}" id="optionValue" readonly="readonly"name ="rang" class="optionfinal"><button type="button" onclick="getCommentList_2_1()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_2_2}" id="optionValue" readonly="readonly" name ="status"class="optionfinal"><button type="button" onclick="getCommentList_2_1()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;

            tr += `<li id="li_final"><input value="${latestOptions_3[0]}" id="optionValue" class="optionfinal" name ="zoneCode" readonly="readonly"><button type="button" onclick="getCommentList_3()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_3[1]}" id="optionValue" class="optionfinal" name ="address"readonly="readonly"><button type="button" onclick="getCommentList_3()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_3[2]}" id="optionValue" readonly="readonly" name ="detailAddress"class=""><button type="button" onclick="getCommentList_3()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_3[3]}" id="optionValue" readonly="readonly" name ="extraAddress"class=""><button type="button" onclick="getCommentList_3()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            
             tr += `<li id="li_final"><input value="${latestOptions_4[0]}" id="optionValue" readonly="readonly" name ="aquareFootage" class="optionfinal"><button type="button" onclick="getCommentList_4()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_4[1]}" id="optionValue" readonly="readonly" name ="squareMeter"class="optionfinal"><button type="button" onclick="getCommentList_4()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_4[2]}" id="optionValue" readonly="readonly"name ="wishBudget" class="optionfinal"><button type="button" onclick="getCommentList_4()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
            tr += `<li id="li_final"><input value="${latestOptions_4[3]}" id="optionValue"  readonly="readonly"name ="requestOp" sclass=""><button type="button" onclick="getCommentList_4()"><span class="material-symbols-outlined" >contract_edit</span></button></li>`;
      ...
      if (option.value.trim() === "필수항목을 입력해주세요." || option.value.trim() === '') {
        ...
        setTimeout(() => {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              // 이 부분에서 원하는 작업을 수행하도록 코드를 작성해주세요.
              // 예를 들어, 다시 시작하거나 다른 동작을 수행할 수 있습니다.
              return true;
            }
          });
