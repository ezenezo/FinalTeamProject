...
@Getter
@ToString
public class PagingHandler_approval {
	...
	public PagingHandler_approval(int totalCount, PagingVO pgvo) {
		this.totalCount = totalCount;
		this.pgvo = pgvo;
	
		// 전체 글 수 / 한 페이지에 표시되는 게시글 수 => 올림(ceil)
		this.endPage=(int)Math.ceil(pgvo.getPageNo()/(double)2)*10;
	...
	public PagingHandler_approval(PagingVO pgvo, int totalCount, List<CommentVO> cmtList) {
