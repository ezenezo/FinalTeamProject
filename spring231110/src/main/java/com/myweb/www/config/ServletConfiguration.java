...
//jsp라인에 대한 설정
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// 파일 업로드 경로
		registry.addResourceHandler("/upload/**").addResourceLocations("file:///D:\\_myweb\\_java\\fileupload\\"); //맨뒤에 구분자 \\ 넣어주기  로컬용 231118
//		registry.addResourceHandler("/upload/**").addResourceLocations("/aj2002/tomcat/webapps/_javaweb/_java/fileUpload"); //맨뒤에 구분자 \\ 넣어주기 카페24용 231118
