...
//	}
	...
	public DataSource dataSource() {
	    ...
	    hikariConfig.setJdbcUrl("jdbc:mariadb://aj2002.cafe24.com:3306/aj2002"); //로컬에서 카페24디비 붙는용231118 (webapps)
//	    hikariConfig.setJdbcUrl("jdbc:mariadb://localhost:3306/springdb");
//	    hikariConfig.setJdbcUrl("jdbc:mariadb://localhost:3306/aj2002"); //카페24배포용 (webapps)
